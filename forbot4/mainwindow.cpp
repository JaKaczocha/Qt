...
{
    ui->comboBox_Device->addItem(device.name() + " " + device.address().toString());
...
{
    QString comboBoxQString = ui->comboBox_Device->currentText();
    ...
    this->socket->connectToService(QBluetoothAddress(deviceAddres),
...
void MainWindow::on_pushButton_DiodeON_clicked()
{
...
void MainWindow::on_pushButton_DiodeOFF_clicked()
{
